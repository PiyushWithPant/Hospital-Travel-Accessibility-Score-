...
def RUN():
    """
    Workflow ---> Travel Accessibility Score  #
    ...
    # Returning the final Travel Accessbility Score per district in uniform order
...
#* RESULTS : BELOW ARE THE FINAL TRAVEL ACCESSIBILITY SCORE (TAS). WE ARE USING SCALED MEAN TRAVEL TIME
